   ...
   <div class="container col-9 rounded-0 d-flex justify-content-between">
              ...
              <div class="card mt-4">
                <div class="card-title d-flex justify-content-between  align-items-center">
                    ...
                    <div class="d-flex align-items-center p-2">
                        <img src="assests/images/profile/<?=$post['profile_pic']?>" alt="" height="30" class="rounded-circle border">&nbsp;&nbsp;<a href="?u=<?=$post['username']?>" class="text-decoration-none text-dark"><?=$post['first_name']?>
                        <?=$post['last_name']?></a>
                    </div>
                    <div class="p-2">
                ...
                <img src="assests/images/posts/<?=$post['post_img']?>" class="" alt="...">
        ...
        <div class="col-4 mt-4 p-3">
            <div class="d-flex align-items-center p-2">
                <div><img src="assests/images/profile/<?=$user['profile_pic']?>" alt="" height="60" class="rounded-circle border">
                </div>
                <div>&nbsp;&nbsp;&nbsp;</div>
            ...
            <div>
                ...
                ?>
                  <div class="d-flex justify-content-between">
                    <div class="d-flex align-items-center p-2">
                        <div><img src="assests/images/profile/<?=$suser['profile_pic']?>" alt="" height="40" class="rounded-circle border">
                        </div>
                        <div>&nbsp;&nbsp;</div>
