...
?>
    <div class="login">
        <div class="col-md-4 col-sm-11 bg-white border rounded p-4 shadow-sm">
            <form method="post" action="assests/php/actions.php?verify_email">
...
<?php
                ...
                <div class="mt-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="assests/php/actions.php?resend_code" class="text-decoration-none" type="submit">Resend Code</a>
                </div>
                <br>
                <a href="assests/php/actions.php?logout" class="text-decoration-none mt-5"><i class="bi bi-arrow-left-circle-fill"></i>
                    Logout</a>
            </form>
        </div>
    </div>
