<?php global $user;?>
    <div class="container col-md-9 col-sm-12 rounded-0 d-flex justify-content-between">
        <div class="col-12 bg-white border rounded p-4 mt-4 shadow-sm">
            <form method="post" action="assests/php/actions.php?updateprofile" enctype="multipart/form-data">
...
<?php
                ...
                <div class="form-floating mt-1 col-md-6 col-sm-12">
                    <img src="assests/images/profile/<?=$user['profile_pic']?>" class="img-thumbnail my-3" style="height:150px;width:150px" alt="...">
                    <div class="mb-3">
